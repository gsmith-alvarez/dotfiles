...
vim.keymap.set('n', '<leader>fc', snacks_call('picker.recent', { filter = { cwd = true } }), { desc = 'Find: Recent (CWD)' })
...
vim.keymap.set('n', '<leader>sn', snacks_call('picker.files', { cwd = vim.fn.stdpath 'config' }), { desc = 'Search: Neovim Config' })
