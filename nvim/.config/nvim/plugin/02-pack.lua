...
vim.pack.add({
	...
	gh("neovim/nvim-lspconfig"), -- The database for our lsps
	gh("folke/lazydev.nvim"), -- For better luaLS setup
...
if
	...
	and vim.fn.filereadable(blink_lib_a) == 0
	and vim.fn.filereadable(blink_lib_b) == 0
then
