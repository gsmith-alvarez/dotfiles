...
-- Automatically attach Treesitter highlighting when entering a buffer of a supported filetype.
...
-- Binaries are resolved via mise (see core/path.lua).
  ...
  vim.lsp.config('lua_ls', {
    ...
    settings = {
      Lua = {
        diagnostics = { globals = { 'vim' } }, -- Recognize 'vim' global variable
